...
\begin{center}
 \only<1>{\includegraphics[width=.7\textwidth]{voice_1024_512xp} \\
 Taille de fenêtre : \structure{23} ms, pas d'avancement 10 ms.}
 \only<2>{\includegraphics[width=.7\textwidth]{voice_2048_512xp} \\
 Taille de fenêtre : \structure{46} ms, pas d'avancement 10 ms.}
 \only<3>{\includegraphics[width=.7\textwidth]{voice_4096_512xp} \\
...
\begin{frame}{Regroupement hiérarchique alterné}

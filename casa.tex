...
\end{itemize}
L'ASA Computationnelle (CASA)\footfullcitenomarkleft{wang2016casa} se propose de mettre en \oe{}uvre ces critères pour inférer une organisation perceptuellement valide de la scène sonore.
\end{frame}
...
\begin{itemize}
  \item $a_{l}[n]=1$
  \item $f_{l}[n]=l*f_0+\sin \left(\frac{2 \pi * 5}{F_{s}} \cdot n \right)+FPB(\mathcal{N})$
...
\begin{center}
\only<2>{\includesound{sounds/asa.mp3} \\ John Chowning (1970-80)}

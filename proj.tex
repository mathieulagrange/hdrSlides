\begin{frame}{\alert{Tâche} : \visible<3>{synthèse}}
\begin{center}
...
\vspace{.8cm}
\only<1>{IR} \only<2>{bss, inpainting, extension de bande, ...}
\end{center}
\visible<3>{
\begin{itemize}
\item attrait personnel pour l'inouï
\item challenge
\item en prise avec les avancées actuelles en apprentissage
\end{itemize}}
\end{frame}

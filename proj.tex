...
\end{description}}
\only<4>{
Pourquoi trvailler sur la synthèse sonore ?
\begin{itemize}
...
\begin{frame}{\only<1>{Conclusion}\only<9>{Un travail en inter-disciplinarité} \only<2>{France Télécom R\&D (2001-04)}\only<3>{Bx (2004-06)}\only<4>{Uvic (2006-07)}\only<5>{McGill (2007-08)}\only<6>{Télécom (2008-09)}\only<7>{Ircam (2009-13)}\only<8>{Ls2n (2013-19)}}
  \begin{tikzpicture}[mystyle]
